        ...
        body: Column(
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                setState(() {
                  if(0 == allQuestions[questionIndex]["answerIndex"]) {
                      isCorrectAns1 = true;
            ...
            ElevatedButton(
              onPressed: () {
                setState(() {
                  if(1 == allQuestions[questionIndex]["answerIndex"]) {
                  isCorrectAns2 = true;
                }
                });
              },
            ...
            ElevatedButton(
              onPressed: () {
                setState(() {
                  if(2 == allQuestions[questionIndex]["answerIndex"]) {
                    isCorrectAns3 = true;
                  }
                });
              },
            ...
            ElevatedButton(
              onPressed: () {
                setState(() {
                  if(3 == allQuestions[questionIndex]["answerIndex"]) {
                    isCorrectAns4 = true;
                  }
                });
              },
